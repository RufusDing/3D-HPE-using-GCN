...
from common.data_utils import fetch, read_3d_data, create_2d_data, compute_scale_pytorch, prepare_data
...
def parse_args():
    ...
    #cpn_ft_h36m_dbb
    # General arguments
    parser.add_argument('-g', '--gpu_id', default='0', type=str, metavar='NUMBER', help='GPU USAGE')
    ...
    parser.add_argument('--lr_decay', type=int, default=24372, help='num of steps of learning rate decay')
    parser.add_argument('--lr_gamma', type=float, default=0.95, help='gamma of learning rate decay')
...
def main(args,convm):
    ...
    ### remove scale
    #keypoints, dataset = prepare_data(path.join('data', 'data_2d_' + args.dataset + '_' + args.keypoints + '.npz'), dataset)
    ###
    ...
    adj = adj_mx_from_skeleton(dataset.skeleton())#;print(adj)
    model_pos = SemGCN(convm, adj, args.hid_dim, num_layers=args.num_layers, p_dropout=p_dropout,
...
if __name__ == '__main__':
    ...
    convM1 = torch.zeros(17, 17, dtype=torch.float)  #0
    convM2 = torch.zeros(17, 17, dtype=torch.float)  #1
    convM3 = torch.zeros(17, 17, dtype=torch.float)  #-1
    convM1[0,0]=1;convM1[1,1]=1;convM1[2,2]=1;convM1[3,3]=1;convM1[4,4]=1;convM1[5,5]=1;convM1[6,6]=1;convM1[7,7]=1
    convM1[8,8]=1;convM1[9,9]=1;convM1[10,10]=1;convM1[11,11]=1;convM1[12,12]=1;convM1[13,13]=1;convM1[14,14]=1;convM1[15,15]=1;convM1[16,16]
    convM2[0,1]=1;convM2[0,4]=1;convM2[1,2]=1;convM2[2,3]=1;convM2[4,5]=1;convM2[5,6]=1;convM2[7,0]=1;convM2[7,8]=1
    convM2[8,9]=1;convM2[8,11]=1;convM2[8,14]=1;convM2[9,10]=1;convM2[11,12]=1;convM2[12,13]=1;convM2[14,15]=1;convM2[15,16]=1
    convM3[0,7]=1;convM3[1,0]=1;convM3[2,1]=1;convM3[3,2]=1;convM3[4,0]=1;convM3[5,4]=1;convM3[6,5]=1;convM3[8,7]=1
    convM3[9,8]=1;convM3[10,9]=1;convM3[11,8]=1;convM3[12,11]=1;convM3[13,12]=1;convM3[14,8]=1;convM3[15,14]=1;convM3[16,15]=1
    convm = torch.zeros(3, 17, 17, dtype=torch.float)
    convm[0] = convM1; convm[1] = convM2; convm[2] = convM3

    main(parse_args(),convm)
